...
static char StrN1[3][8] = { ' ' };						//1层
static char StrN2[3][8] = { ' ' };						//2层
static char StrN3[3][8] = { ' ' };						//3层
char StrP3[8] = { ' ', ' ', '=', '=', '=', ' ', ' ' };	//小盘
char StrP5[8] = { ' ', '=', '=', '=', '=', '=', ' ' };	//中盘
char StrP7[8] = { '=', '=', '=', '=', '=', '=', '=' };	//大盘
//}
...
void Getin()
{
	...
	//-----------------------------------------------------------------------------------------------------------
	if (CH == '2' && strcmp(StrN1[1], StrI) != 0 && strcmp(StrN1[1], StrP3) == 0)					//如果键入2且2柱顶层不为空且为三
	{
		printf("2");
		CH = _getch();
		if (CH == '1')
	...
	//-----------------------------------------------------------------------------------------------------------
	if (CH == '3' && strcmp(StrN1[2], StrI) != 0 && strcmp(StrN1[2], StrP3) == 0)					//如果键入3且3柱顶层不为空且为三
	{
		printf("3");
		CH = _getch();
		if (CH == '1')
